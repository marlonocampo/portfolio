...
function DescriptionSkills ({ handleShowDescription, currentSkill }: props): JSX.Element {
  ...
  return (
    <article className={`z-40 fixed w-full h-full top-0 flex items-center justify-center 
                      backdrop-blur-sm bg-transparent text-secondary`}
    >
      <div className='w-[500px] bg-primary rounded-2xl p-8 shadow-xl slide-up prose text-secondary border border-3 border-secondary-focus'>
